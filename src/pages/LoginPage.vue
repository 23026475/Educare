<template>
    <div
      class="w-full relative bg-teal-100 overflow-hidden flex flex-col items-start justify-start py-0 pl-[571px] pr-0 box-border leading-[normal] tracking-[normal] mq975:pl-5 mq975:box-border mq1000:pl-[285px] mq1000:box-border"
    >
      <form
        class="m-0 w-[902px] rounded-tl-21xl rounded-tr-sm rounded-br-sm rounded-bl-21xl bg-white flex flex-col items-start justify-start pt-0 pb-[149px] pl-[66px] pr-[33px] box-border relative gap-[47px] max-w-[104%] mq450:pl-[33px] mq450:pb-[97px] mq450:box-border mq975:gap-[23px] mq975:pb-[63px] mq975:box-border"
      >
        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <div
                class="h-[61px] flex-1 relative text-17xl font-semibold font-syne text-gray text-center flex items-center justify-center max-w-full z-[2] mq975:text-3xl mq1000:text-10xl"
              >
                Login
              </div>
            </button>
        ...
        <h1
          class="!m-[0] w-[673px] absolute top-[107px] left-[-599px] text-21xl font-semibold font-syne text-white text-center flex items-center justify-center z-[4] mq975:text-5xl mq1000:text-13xl"
        >
